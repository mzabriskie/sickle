...
QUnit.test('attribute selectors', function (assert) {
    ...
    assert.equal(document.getElement('link[href=../bower_components/qunit/qunit/qunit.css?version=12345]'), document.getElementById('qunit-css'), 'document.getElement should find the correct element');
});
